...
@php
    $path = url("/packages/workdo/Audit/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Audit')}}<b>{{__('Payment')}}</b>{{__('Gateway')}}</h2>
                <p>{{__('Audit is an online payment processing and credit card processing platform for businesses. ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Why use Audit payment?')}}</h2>
                        </div>
                        <p>{{__('Audit Payments is a powerful payment processor for online sales. It can accept dozens of payment methods and more than 135 currencies. And its advanced developer tools allow you to create a checkout flow that feels custom, provided you know how to use them.')}}</p>
                    </div>
                </div>
